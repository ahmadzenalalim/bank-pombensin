...
<body>
    <h1 class="title">Daftar Rental Motor</h1>
    <center>
    <table border="1" cellpadding="10" cellspacing="3">
        ...
        <tr align="center">
            ...
            <td>
                <a href="hapus.php?id_nasabah=<?php echo $pelanggan["id_nasabah"] ?>"onclick="return confirm('Yakin Akan Di hapus <?php echo $nasabah['nama']?>')">Hapus</a> |
                <a href="update.php?id_nasabah=<?php echo $pelanggan["id_nasabah"] ?>"onclick="return confirm('Yakin Akan Di ubah <?php echo $nasabah['nama']?>')">Update</a>
            </td>
        </tr>
        <?php }?>
    </table>
